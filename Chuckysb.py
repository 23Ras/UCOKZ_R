...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token="ErnVDb2sYq6knsk5fkoc.wmhn95zpBixjW6ozOZTQZa.8li4JwFx/NSQAlj86eH36dvUNp3tNAROIrUCtMxOnAk=")
nadya.loginResult()
...
╠═════════════════════════
║             💠 By : Bang UCOKZ💠
║    〽️ http://line.me/ti/p/1MV1EvNMyN〽️
╚═════════════════════════
"""
...
Bots=[mid]
Creator=["u58c1cdf7964f6c85c9c3a399a33b6acc"]
admin=["u58c1cdf7964f6c85c9c3a399a33b6acc"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : Bang UCOKZ_R\nContact Me : 👉http://line.me/ti/p/1MV1EvNMyN",    
    "commentOn":True,
    "commentBlack":{},
...
#                            Name = summon(op.param2)
        ...
        if op.type == 25:
          if wait["Bot"] == True:    
			...
			nadya.sendText(msg.to,"Admin Detected~")
                ...
                msg.contentType = 13
                msg.contentMetadata = {'u1df1f61244057c16b56190d7e736b695': tjia}
                nadya.sendMessage(msg)
		...
		nadya.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["Key","help","Help","Kasih help"]:
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to, "Khusus Rizone")
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus Nadya")
                ...
                wait["Sider"] = True
                nadya.sendText(msg.to,"Siap Berburu Janda BOZKU yang ganteung")
                
            elif "Buru off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    nadya.sendText(msg.to, "Berburu janda Off BOSKU")
                else:
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '13835595',
                                    'STKPKGID': '7451',
                                    'STKVER': '4'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '206292',
                                    'STKPKGID': '1003601',
                                    'STKVER': '2'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '17994',
                                    'STKPKGID': '1073',
                                    'STKVER': '2'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '23084625',
                                    'STKPKGID': '1715280',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '206299',
                                    'STKPKGID': '1003601',
                                    'STKVER': '2'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '206284',
                                    'STKPKGID': '1003601',
                                    'STKVER': '2'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '23084616',
                                    'STKPKGID': '1715280',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '206304',
                                    'STKPKGID': '1003601',
                                    'STKVER': '2'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '206308',
                                    'STKPKGID': '1003601',
                                    'STKVER': '2'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '23084608',
                                    'STKPKGID': '1715280',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)

            elif msg.text.lower() in ["ngejek","jangan ih"]:
                msg.contentType = 7
                msg.contentMetadata={'STKID': '23084618',
                                    'STKPKGID': '1715280',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)

            elif msg.text.lower() in ["nangis","sedih","Ngopi"]:
                msg.contentType = 7
                msg.contentMetadata={'STKID': '23084610',
                                    'STKPKGID': '1715280',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
            ...
            elif msg.text in ["Setview","Setpoint","Cctv","Setlastpoint"]:
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                midd = "u4c30564b0fd1027058474136e8bea3e4"
                nadya.inviteIntoGroup(msg.to,[midd])

            elif msg.text in ["Welcome","welcome","Welkam","welkam","Wc","wc"]:
                gs = nadya.getGroup(msg.to)
                nadya.sendText(msg.to,"Selamat Datang Di "+ gs.name+"Dan selamat bergabung..😊😊 jangan lupa kenalan sama yang lain ya kk.😆😆awas jangan baper....  ▶Budayakan Baca Note Ya kak▶Dilarang Nikung😁😁😁▶No Baber😜😜😜▶Salam Cipok😘😘😘")
                msg.contentType = 7
                msg.contentMetadata={'STKID': '23084615',
                                    'STKPKGID': '1715280',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
		...
		if msg.from_ in Creator:
		    for i in gid:
			nadya.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n\nContact Me : http://line.me/ti/p/NiXVnQYRL4")
		...
		nadya.sendText(msg.to,"Hadir!!")
            ...
            elif msg.text in ["Lr","Lari","L"]:
                start = time.time()
                print("LARINYA LEMOT BOZ ")                
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["http://dl.profile.line-cdn.net/0hFzkB3eTQGVVWOzWuTqNmAmp-FzghFR8dLg0FM3o_RTZ5XF9XPQpeNHUzF2MuDF5WbA4FMiFrQGZy"]
                ...
                nadya.sendAudio(msg.to,"hasil.mp3")
                    ...
                    beb = "Hi Sayang  " +nadya.getContact(msg.from_).displayName + " 􀸂􀆇􏿿4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.04.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4.4.4.0.0.0.0.4.0.4.0.4.0.4.0.4.0.4.4"
